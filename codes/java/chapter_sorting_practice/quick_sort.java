 ...
 */
 ...
 class QuickSortNew {
     ...
     static int partition(int[] nums, int left, int right) {
         ...
         nums[left] = pivot;  // 当 left 和 right 重合的时候
         return left;         // 返回基准数的索引, 这里返回 left 或者 right 都可以，因为已经重合了
     }
 ...
 public class quick_sort {
     public static void main(String[] args) {
         /* 快速排序 */
         int[] nums0 = { 2, 4, 1, 0, 3, 5, 9,0,5,7 };
         QuickSortNew.quickSort(nums0, 0, nums0.length - 1);
         System.out.println("更好理解的快速排序完成后 nums = " + Arrays.toString(nums0));
